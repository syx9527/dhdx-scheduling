...
<!--      <el-table-column label="del_flag" align="center" prop="dutyId" />-->
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('duty/duty/export', {
        ...this.queryParams
