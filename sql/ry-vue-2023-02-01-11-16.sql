...
INSERT INTO `sys_dept` VALUES (209, 100, '0,100', '测试部门', 1, NULL, NULL, NULL, '0', '0', 'admin', '2023-01-31 21:15:31', '', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '值班类型' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_duty
-- ----------------------------
INSERT INTO `sys_duty` VALUES (12, '白班', 1, 'admin', '2023-01-30 02:09:32', 'admin', '2023-01-30 02:14:17', NULL, '0');
INSERT INTO `sys_duty` VALUES (13, '行政值班', NULL, 'admin', '2023-01-30 09:09:52', NULL, NULL, NULL, '0');
INSERT INTO `sys_duty` VALUES (14, '夜班', NULL, 'admin', '2023-01-30 09:10:54', NULL, NULL, NULL, '0');
...
) ENGINE = InnoDB AUTO_INCREMENT = 57 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '值班记录' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 492 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_role` VALUES (2, '普通角色', 'common', 2, '5', 1, 1, '0', '0', 'admin', '2023-01-18 15:42:13', 'admin', '2023-01-30 18:39:33', '普通角色');
INSERT INTO `sys_role` VALUES (100, '主任', 'dempBoss', 3, '4', 1, 1, '0', '0', 'admin', '2023-01-19 10:08:17', 'admin', '2023-01-30 18:39:38', NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$YEnCji3QWGG8OmE2mEb/6OgPcbGpFdsBewlXRqaFCwwe5w.fjdn0y', '0', '0', '127.0.0.1', '2023-02-01 11:14:12', 'admin', '2023-02-01 09:33:05', '', '2023-02-01 11:14:11', '管理员');
INSERT INTO `sys_user` VALUES (2, 105, 'ry', '若依', '00', 'ry@qq.com', '15666666666', '1', '', '$2a$10$ITBERKQW7h2/gFy8rUCLZu3BhZmUAU6cEIaVVH3TRrbQhXjagfLDK', '0', '0', '127.0.0.1', '2023-02-01 09:33:06', 'admin', '2023-02-01 09:33:06', '', NULL, '测试员');
INSERT INTO `sys_user` VALUES (100, NULL, 'test', 'test', '00', '', '', '0', '', '$2a$10$yJHEY/dlQQV./9fyFP5JMOaMaK5DjcNkjwK8TxTJODm3FHCUeYNJW', '0', '0', '127.0.0.1', '2023-02-01 11:09:33', 'admin', '2023-02-01 11:01:58', '', '2023-02-01 11:09:33', NULL);
